...
const repeatMyParam = () => {
    //YOUR CODE HERE
    return axios.get(`http://localhost:3000/repeat/derik`)
    .then(res => {
        console.log(res.data)
        
        let myResult = document.getElementById('repeat-text')
        myResult.textContent = res.data
...
// CODE HERE
const queryRequest = () => {
    axios.get(`http://localhost:3000/query-test?is-this-a-query=first-value&next-query=second-value`)
